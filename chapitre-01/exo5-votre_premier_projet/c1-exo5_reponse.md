## apres avoir creer Applications/MonEssai, MonEssai.jenga et main.cpp et apres avoir declarer le workspace j'ai tape la commande jenga info mon projet se trouve dans le workspace
